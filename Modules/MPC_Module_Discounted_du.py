...
class ModelPredictiveControl:
    ...
    Dist = Exterrnal Disturbance
    Gamma = Discount factor
    S = Change in input tuning matrix
    Ss_States = Steady state states
    ...
    def stage_loss(self, states, inputs, parameter, Du):
        ...
        du_cost = mpc.mtimes(Du.T, self.S, Du)

        return (x_cost + u_cost + du_cost)*self.gamma**parameter
    ...
    def get_mpc_controller(self, ode_casadi, delta, x0, random_guess=False, c=3, verbosity=0, upper_bound=1.8,
        ...
        loss = mpc.getCasadiFunc(self.stage_loss, [self.Nx, self.Nu, shape, 1], ["x", "u", "p", "Du"], funcname="loss")
