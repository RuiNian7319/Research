...
class MimoCstr:
    ...
    def __init__(self, nsim, delta=1, nx=3, nu=2, nt=10, f0=0.1, t0=350, c0=1, r=0.219, k0=7.2e10, er_ratio=8750,
        ...
        self.cstr_ode_control = mpc.getCasadiFunc(self.ode_control, [self.Nx * 2, self.Nu], ["x", "u"], funcname="odef")
    ...
    """
    Ordinary differential equation of the CSTR for control purposes.  Allows for model updating to improve CSTR
    performance.
    ...
    def ode_control(self, state, inputs):
        c = state[0]
        t = state[1]
        h = state[2]
