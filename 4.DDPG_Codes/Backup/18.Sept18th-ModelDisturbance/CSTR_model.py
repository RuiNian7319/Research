...
class MimoCstr:
    ...
    def __init__(self, nsim, delta=1, nx=3, nu=2, nt=10, f0=0.1, t0=350, c0=1, r=0.219, k0=7.2e10, er_ratio=8750,
                 ...
                 x0=np.array([1, 310, 0.659]), u0=np.array([300, 0.1]), control=False, q_cost=1, r_cost=0.5):
        ...
        self.action_space = Box(low=-7, high=7, shape=(1, ))
    ...
    def reward_function(self, t, action):
        ...
        # r = self.r_cost * np.eye(self.Nu)
        #
        # rewards = -(dx @ q @ dx.T + du @ r @ du.T) + 0.25
...
if __name__ == "__main__":
    ...
    cstr = MimoCstr(nsim=20, x0=np.array([0.927, 317.78, 0.659]), u0=np.array([295, 0.1]))
